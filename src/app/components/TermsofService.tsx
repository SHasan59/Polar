  ...
  return (
    <div className="bg-black text-white max-w-2xl mx-auto mt-8 px-4 py-8 rounded-lg shadow-lg">
      ...
      <p className="text-gray-300 mb-6">
        ...
        and be bound by the following terms and conditions. Please read the
        following terms carefully before using our services.
      </p>
      ...
      <div className="border-t border-gray-600 py-6">
        ...
        <p className="text-gray-300 mb-4">
          ...
          without notice. We do not warrant that the services will be error-free
          or uninterrupted.
        </p>
      </div>
      ...
      <div className="border-t border-gray-600 py-6">
        ...
        <p className="text-gray-300 mb-4">
          ...
          time. The updated terms will be effective immediately upon posting on
