...
function Slide(){
    return (
        <div className="grid md:grid-cols-2">
            <div className="image">
                <Link href={"#"}><Image src={"/images/polarblack.png"} width={600} height={500} /></Link>
            </div>
            <div className="info flex justify-center flex-col">
                ...
                <div className="title">
                    <Link href ={"#"} className="text-3xl md:text-6xl font-bold text-white-800 hover:text-gray-600">The Polar Bear Game is the best games ever.</Link>
                </div>
