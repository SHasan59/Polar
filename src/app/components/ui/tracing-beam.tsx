...
export const TracingBeam = ({
  ...
  return (
    <motion.div
      ref={ref}
      className={cn('relative w-full max-w-6xl mx-auto h-100', className)}
    >
      <div className="absolute -left-40 top-0">
        <motion.div
          ...
          className="ml-[7px] h-6 w-6 rounded-full border border-netural-200 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
      ...
      <div ref={contentRef} className="ml-0">
        {children}
      </div>
    </motion.div>
  );
