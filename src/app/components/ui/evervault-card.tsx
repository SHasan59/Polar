...
export const EvervaultCard = ({
  ...
  useEffect(() => {
    let str = generateRandomString(50000);
    setRandomString(str);
  }, []);
  ...
  return (
    ...
    >
      <div
        ...
        // Increase the width of the card to make it wider
        style={{ width: "1500px" }}
      >
        <CardPattern
          mouseX={mouseX}
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h1- w-100 rounded-full flex items-center justify-center text-white font-bold text-4xl">
